  ...
  contentSecurityPolicy: {
    directives: {
      ...
      frameSrc:      ["'self'", 'https://demo.docusign.net', 'https://www.docusign.net',
                      'https://account-d.docusign.com', 'https://account.docusign.com','https://*.docusign.net', 'https://*.docusign.com'],
      connectSrc:    ["'self'", 'https://account-d.docusign.com', 'https://account.docusign.com',
                      'https://demo.docusign.net', 'https://www.docusign.net','https://*.docusign.net', 'https://*.docusign.com'],
      imgSrc:        ["'self'", 'data:'],
    },
  },
}));
